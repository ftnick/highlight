    ...
    var n = [
        ...
        function (t) {
          ...
          ((_.prototype.clone_empty = function () {
            ...
            return (
              t.set_indent(this.__indent_count, this.__alignment_count),
              t
            );
          }),
            ...
            (i.prototype.get_indent_size = function (t, e) {
              ...
              return (i =
                (i = t < 0 ? 0 : i) + t * this.__indent_size + (e = e || 0));
            }),
        ...
        function (t) {
          ...
          ((e.prototype.restart = function () {
            ...
            (e.prototype.readUntil = function (t, e) {
              ...
              return (
                t
                  ? ((i = t.index), e && (i += t[0].length))
                  : (i = this.__input_length),
                (e = this.__input.substring(this.__position, i)),
                (this.__position = i),
                e
              );
            }),
        ...
        function (t, e, i) {
          ...
          ((_.prototype.eatString = function (t) {
            ...
            (_.prototype.eatWhitespace = function (t) {
              for (
                var e = k.test(this._input.peek()), i = 0;
                k.test(this._input.peek());
              )
                ((this._ch = this._input.next()),
                  t &&
                    "\n" === this._ch &&
            ...
            (_.prototype.beautify = function () {
              ...
              for (
                var t,
                  ...
                  s =
                    ("auto" === _ &&
                      ((_ = "\n"), n && m.test(n || "") && (_ = n.match(m)[0])),
                    (n = n.replace(b, "\n")).match(/^[\t ]*/)[0]),
                  r =
                    ((this._output = new w(this._options, s)),
                    (this._input = new y(n)),
                    (this._indentLevel = 0),
                    (this._nestedLevel = 0),
                    (this._ch = null),
                ...
                if ("/" === this._ch && "*" === this._input.peek()) {
                  ...
                  var d = this._input.read(O),
                    f = v.get_directives(d);
                  (f &&
                    "start" === f.ignore &&
                    (d += v.readIgnored(this._input)),
                    this.print_string(d),
                    ...
                    "{" === this._input.peek()
                      ...
                      : (this.print_string(this._ch),
                        (d =
                          ...
                          ((d = this.eatString(": ").replace(/\s+$/, "")),
                          this.print_string(d),
                          (this._output.space_before_token = !0)),
                        0 === r && -1 !== d.indexOf(":")
                          ? ((o = !0), this.indent())
                          : d in this.NESTED_AT_RULE
                            ? ((this._nestedLevel += 1),
                              d in this.CONDITIONAL_GROUP_RULE && (p = !0))
                            : 0 !== r || o || (a = !0)));
                else if ("#" === this._ch && "{" === this._input.peek())
                  (this.preserveSingleSpace(t),
                    this.print_string(this._ch + this.eatString("}")));
                  ...
                  (o && ((o = !1), this.outdent()),
                    (a = !1),
                    (h = p
                      ? ((p = !1), this._indentLevel >= this._nestedLevel)
                  ...
                  0 !== r
                    ...
                    : (this.print_string(":"),
                      o ||
                        ((this._output.space_before_token = o = !0),
                        this.eatWhitespace(!0),
                        this.indent()));
                } else
                  '"' === this._ch || "'" === this._ch
                    ? (this.preserveSingleSpace('"' === e || "'" === e || t),
                          ...
                          ? (this.print_string(this._ch),
                            ...
                            "'" === this._ch
                              ...
                              : this._ch &&
                                ...
                                r && (r--, this.outdent())))
                          : ((i = !1),
                            this._input.lookBack("with") && (i = !0),
                            this.preserveSingleSpace(t || i),
                            this.print_string(this._ch),
                            o &&
                            "$" === e &&
                            this._options.selector_separator_newline
                              ? (this._output.add_new_line(), (u = !0))
                              ...
                              : this._options.space_around_combinator
                                ...
                                : (this.print_string(this._ch),
                                  ...
                                  this._ch &&
                                    k.test(this._ch) &&
                                    (this._ch = ""));
              return this._output.get_code(_);
            }),
          ...
          function _(t) {
            ...
            var t = this._get_boolean("space_around_selector_separator"),
              e =
                ...
                this._get_selection_list("brace_style", [
                  "collapse",
                  "expand",
                  "end-expand",
                  "none",
