  ...
  !(function () {
    ...
    var i = [
        ...
        function (t, e, n) {
          ...
          (((_.prototype = new i()).__set_whitespace_patterns = function (
            t,
            e,
          ) {
        ...
        function (t, e, n) {
          ...
          ((d.prototype.get_parser_token = function () {
            ...
            (g.prototype.beautify = function () {
              ...
              for (
                ...
                (o.type === u.TAG_OPEN || o.type === u.COMMENT
                  ? (_ = a = this._handle_tag_open(s, o, _, i, r))
                  : o.type === u.ATTRIBUTE ||
                      o.type === u.EQUALS ||
                      o.type === u.VALUE ||
                      (o.type === u.TEXT && !_.tag_complete)
                    ? (a = this._handle_inside_tag(s, o, _, i))
                    : o.type === u.TAG_CLOSE
            ...
            (g.prototype._handle_tag_open = function (t, e, n, i, _) {
              ...
              if (
                ...
                for (
                  var r, a = 0;
                  (r = _.peek(a)).type === u.ATTRIBUTE && (s.attr_count += 1),
                    (a += 1),
                    r.type !== u.EOF && r.type !== u.TAG_CLOSE;
                );
              return (
                (this._is_wrap_attributes_force_aligned ||
                  this._is_wrap_attributes_aligned_multiple ||
