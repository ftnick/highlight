!(function (e) {
            ...
            static _utf8ByteLength(e) {
              ...
              for (let s = 0, a = e.length; s < a; s++) {
                ...
                if (n >= 55296 && n <= 56319 && s + 1 < a) {
                  ...
                  t >= 56320 &&
                    t <= 57343 &&
                    ((r = (65536 + ((n - 55296) << 10)) | (t - 56320)),
                    (o = !0));
                }
                ((t += r <= 127 ? 1 : r <= 2047 ? 2 : r <= 65535 ? 3 : 4),
                  o && s++);
              }
              return t;
            }
          ...
          var t =
            ...
            function (e) {
              ...
              function f(e, t, s) {
                ...
                if (n - t > 16 && e.buffer && g)
                  return g.decode(e.subarray(t, n));
                for (var r = ""; t < n; ) {
                  var o = e[t++];
                  if (128 & o) {
                    var i = 63 & e[t++];
              ...
              function R(e) {
                try {
                  return (
                    c.grow((e - p.byteLength + 65535) >>> 16),
                    y(c.buffer),
                    1
                  );
                } catch (e) {}
              ...
              if (
                ...
                (a.___wasm_call_ctors = function () {
                  return (a.___wasm_call_ctors = a.asm.__wasm_call_ctors).apply(
                    null,
                    arguments,
                  );
                }),
                ...
                (a._getLastOnigError = function () {
                  return (a._getLastOnigError = a.asm.getLastOnigError).apply(
                    null,
                    arguments,
                  );
                }),
                (a._createOnigScanner = function () {
                  return (a._createOnigScanner = a.asm.createOnigScanner).apply(
                    null,
                    arguments,
                  );
                }),
                (a._freeOnigScanner = function () {
                  return (a._freeOnigScanner = a.asm.freeOnigScanner).apply(
                    null,
                    arguments,
                  );
                }),
                (a._findNextOnigScannerMatch = function () {
                  return (a._findNextOnigScannerMatch =
                    a.asm.findNextOnigScannerMatch).apply(null, arguments);
                }),
                (a._findNextOnigScannerMatchDbg = function () {
                  return (a._findNextOnigScannerMatchDbg =
                    a.asm.findNextOnigScannerMatchDbg).apply(null, arguments);
                }),
                (a.stackSave = function () {
                  return (a.stackSave = a.asm.stackSave).apply(null, arguments);
                }),
                (a.stackRestore = function () {
                  return (a.stackRestore = a.asm.stackRestore).apply(
                    null,
                    arguments,
                  );
                }),
                (a.stackAlloc = function () {
                  return (a.stackAlloc = a.asm.stackAlloc).apply(
                    null,
                    arguments,
                  );
                }),
                (a.dynCall_jiji = function () {
                  return (a.dynCall_jiji = a.asm.dynCall_jiji).apply(
                    null,
                    arguments,
                  );
                }),
  ...
  function g(e, t = !1) {
    ...
    function m() {
      ...
      switch (t) {
        ...
        case 47:
          ...
          if (42 === e.charCodeAt(a + 1)) {
            ...
            for (; a < t; ) {
              ...
              (a++,
                y(t) &&
                  (13 === t && 10 === e.charCodeAt(a) && a++, i++, (l = a)));
            }
        ...
        case 45:
          if (
            ((n += String.fromCharCode(t)), a++, a === s || !b(e.charCodeAt(a)))
          )
            return (o = 16);
        case 48:
        case 49:
          ...
          return (
            (n += (function () {
              ...
              if (a < e.length && 46 === e.charCodeAt(a)) {
                if ((a++, !(a < e.length && b(e.charCodeAt(a)))))
                  return ((p = 3), e.substring(t, a));
      ...
      (function (e, t, s = p.DEFAULT) {
        ...
        function C() {
          ...
          for (; 4 !== a.getToken() && 17 !== a.getToken(); ) {
            if (5 === a.getToken()) {
              if ((t || S(4, [], []), y(","), L(), 4 === a.getToken() && k))
                break;
            } else t && S(6, [], []);
            (e ? (n.push(0), (e = !1)) : n[n.length - 1]++,
              x() || S(4, [], [4, 5]),
              (t = !0));
          }
          return (
        ...
        if ((L(), 17 === a.getToken()))
          return !!s.allowEmptyContent || (S(4, [], []), !1);
        if (!x()) return (S(4, [], []), !1);
        17 !== a.getToken() && S(9, [], []);
      })(
        e,
  ...
  const k = "undefined" != typeof self && void 0 !== self.WorkerGlobalScope,
    ...
    P = k || (!L && !S);
  let v = "https://unpkg.com/shiki@0.14.5/",
    j = "";
  const w = "dist/";
  function C(e) {
    j = e;
  ...
  function I(e) {
    ...
    return (
      ...
      (a.settings[0] && a.settings[0].settings && !a.settings[0].scope) ||
        a.settings.unshift({
          settings: { foreground: a.fg, background: a.bg },
        }),
      s
    );
  }
          ...
          class r {
            constructor(e, t) {
              ((this._getBasicScopeAttributes = new a.CachedFn((e) => {
                ...
                (this._embeddedLanguagesMatcher = new o(
                  Object.entries(t || {}),
                )));
            }
          ...
          class g {
            constructor(e, t, s, a, n, o, i, c) {
              if (
                ...
                (this._basicScopeAttributesProvider =
                  new u.BasicScopeAttributesProvider(s, a)),
                (this._rootId = -1),
                (this._lastRuleId = 0),
            ...
            getInjections() {
              if (
                ...
                for (const e of this._injections)
            ...
            getExternalGrammar(e, t) {
              ...
              if (this._grammarRepository) {
                ...
                if (s)
                  return (
                    (this._includedGrammars[e] = f(s, t && t.$base)),
            ...
            _tokenize(e, t, s, a) {
              ...
              if (
                ...
                let i;
                ((i = o
                  ? y.createRootAndLookUpScopeName(o, a, this)
                  : y.createRoot("unknown", a)),
          ...
          class _ {
            ...
            produceFromScopes(e, t) {
              ...
              if (this._emitBinaryTokens) {
                ...
                if (
                  (r &&
                    (s = n.EncodedTokenAttributes.set(s, 0, 8, r, -1, 0, 0)),
        ...
        965: (e, t, s) => {
          ...
          function u(e, t, s) {
            for (const o of e) {
              ...
              s.visitedRule.add(o);
              const e = o.repository
                ? a.mergeObjects({}, t.repository, o.repository)
                : t.repository;
              Array.isArray(o.patterns) &&
                u(o.patterns, { ...t, repository: e }, s);
              const i = o.include;
              if (!i) continue;
              const p = f(i);
              switch (p.kind) {
          ...
          function c(e, t, s, n, c, p, m, d) {
            ...
            if (m) {
              const o = (function (e, t, s, n, o, i) {
                ...
                for (let t = o; t; t = t.pop()) {
                  const s = t.getRule(e);
                  s instanceof r.BeginWhileRule &&
                    l.push({ rule: s, stack: t });
                }
                for (let p = l.pop(); p; p = l.pop()) {
                  ...
                  d.captureIndices &&
                    ...
                    d.captureIndices[0].end > n &&
                      ((n = d.captureIndices[0].end), (s = !1)));
                }
                return {
                  stack: o,
                  linePos: n,
            ...
            function _() {
              a.DebugFlags.InDebugMode &&
                (console.log(""),
                console.log(
                  `@@scanNext ${n}: |${t.content.substr(n).replace(/\n$/, "\\n")}|`,
                ));
              const i = (function (e, t, s, n, r, i) {
                const c = (function (e, t, s, n, r, i) {
                    const c = r.getRule(e),
                      { ruleScanner: u, findOptions: p } = l(
                        c,
                        e,
                        r.endRule,
                        s,
                    ...
                    if (a.DebugFlags.InDebugMode) {
                      ...
                      (e > 5 &&
                        ...
                        console.log(
                          `  scanning for (linePos: ${n}, anchorPosition: ${i})`,
                        ),
                    ...
                    return m
                      ? {
                          captureIndices: m.captureIndices,
              ...
              if (m === r.endRuleId) {
                ...
                (a.DebugFlags.InDebugMode &&
                  console.log(
                    "  popping " + r.debugName + " - " + r.debugEndRegExp,
                  ),
                ...
                if (
                  ((c = c.push(m, n, y, u[0].end === g, null, b, b)),
                  o instanceof r.BeginEndRule)
                ) {
                  const n = o;
                  (a.DebugFlags.InDebugMode &&
                    console.log(
                      "  pushing " + n.debugName + " - " + n.debugBeginRegExp,
                    ),
                  ...
                  if (
                    ...
                    n.endHasBackReferences &&
                      (c = c.withEndRule(
                        n.getEndWithResolvedBackReferences(t.content, u),
                      )),
                    !d && i.hasSameRuleAs(c))
                  )
                    return (
                  ...
                  const n = o;
                  (a.DebugFlags.InDebugMode &&
                    console.log("  pushing " + n.debugName),
                    h(e, t, s, c, p, n.beginCaptures, u),
                    p.produce(c, u[0].end),
                    (y = u[0].end));
                  const r = n.getContentName(t.content, u),
                  ...
                  if (
                    ...
                    n.whileHasBackReferences &&
                      (c = c.withEndRule(
                        n.getWhileWithResolvedBackReferences(t.content, u),
                      )),
                    !d && i.hasSameRuleAs(c))
                  )
                    return (
                  ...
                  if (
                    (a.DebugFlags.InDebugMode &&
                      console.log(
                        "  matched " + n.debugName + " - " + n.debugMatchRegExp,
                      ),
          ...
          function h(e, t, s, a, r, o, i) {
            ...
            for (let t = 0; t < u; t++) {
              ...
              if (
                ...
                (c(e, g, s && 0 === d.start, d.start, m, r, !1, 0),
                  n.disposeOnigString(g));
                continue;
              }
        ...
        974: (e, t) => {
              ...
              for (; r(i, c); ) {
                if (0 === l) {
                  if (
                    ...
                    ((u = {}),
                      o && (u.$vscodeTextmateLocation = c.toLocation(t)),
                      m(),
                      (l = 1));
                    continue;
                  }
          ...
          function r(e, t) {
            ...
            if (((t.offset = r), (t.line = i), (t.char = c), 34 === a)) {
              ...
              if (((t.type = 8), r++, c++, (a = n.charCodeAt(r)), 117 !== a))
                return !1;
              if ((r++, c++, (a = n.charCodeAt(r)), 108 !== a)) return !1;
              if ((r++, c++, (a = n.charCodeAt(r)), 108 !== a)) return !1;
              (r++, c++);
            } else if (116 === a) {
              if (((t.type = 9), r++, c++, (a = n.charCodeAt(r)), 114 !== a))
                return !1;
              if ((r++, c++, (a = n.charCodeAt(r)), 117 !== a)) return !1;
              if ((r++, c++, (a = n.charCodeAt(r)), 101 !== a)) return !1;
              (r++, c++);
            } else if (102 === a) {
              if (((t.type = 10), r++, c++, (a = n.charCodeAt(r)), 97 !== a))
                return !1;
              if ((r++, c++, (a = n.charCodeAt(r)), 108 !== a)) return !1;
          ...
          (n(s(44), t),
            (t.Registry = class {
              ...
              async _loadGrammar(e, t, s, a, n) {
                ...
                for (; r.Q.length > 0; )
                  (await Promise.all(
                    r.Q.map((e) => this._loadSingleGrammar(e.scopeName)),
                  ),
                    r.processQueue());
          ...
          function s(e, t, s) {
            ...
            for (; n < a && (l(), !(n >= a)); ) {
              ...
              if (!/^plist/.test(g.name))
                return N("unexpected opened tag " + g.name);
            }
            var O;
            return d;
          }
        ...
        792: (e, t, s) => {
          ...
          class i {
            constructor(e, t, s, n) {
              ((this.$location = e),
                ...
                (this._contentNameIsCapturing = a.RegexSource.hasCaptures(
                  this._contentName,
                )));
            }
            get debugName() {
          ...
          class m {
            ...
            static _compilePatterns(e, t, s) {
              ...
              return {
                patterns: a,
                hasMissingPatterns: (e ? e.length : 0) !== a.length,
              };
            }
          }
          t.RuleFactory = m;
          class d {
            ...
            resolveBackReferences(e, t) {
              ...
              return (
                (o.lastIndex = 0),
                this.source.replace(o, (e, t) =>
                  a.escapeRegExpCharacters(s[parseInt(t, 10)] || ""),
                )
              );
            }
            _buildAnchorCache() {
        ...
        583: (e, t, s) => {
          ...
          class n {
            constructor(e, t, s) {
              ((this._colorMap = e),
                (this._defaults = t),
                (this._root = s),
                (this._cachedMatchRoot = new a.CachedFn((e) =>
                  this._root.match(e),
                )));
            }
          ...
          class h {
            ...
            insert(e, t, s, a, n, r) {
              ...
              (-1 === l
                ? ((o = t), (i = ""))
                : ((o = t.substring(0, l)), (i = t.substring(l + 1))),
            ...
            _doInsertHere(e, t, s, n, r) {
              if (null !== t) {
                for (
                  let o = 0, i = this._rulesWithParentScopes.length;
                  o < i;
                  o++
                ) {
  ...
  function W(e, t, s) {
    ...
    for (let r = 0, o = e.settings.length; r < o; r++) {
      ...
      for (let e = 0, r = o.length; e < r; e++) {
        let c = o[e].split(/ /);
        U(c[c.length - 1], c.slice(0, c.length - 1), t, s) &&
          ((a[n++] = i), (e = r));
      }
    }
    return a;
  ...
  function z(e, t) {
    ...
    if (-1 !== s && "[" === e[s + 1]) {
      ...
      return {
        sequence: e.substring(s + 2, t).split(";"),
        startPosition: s,
        position: t + 1,
      };
    }
        ...
        if (0 === a) t.push({ type: "resetAll" });
          ...
          49 === a
            ...
            : a >= 90 && a <= 97
              ? t.push({
                  type: "setForegroundColor",
                  value: { type: "named", name: q[a - 90 + 8] },
                })
              : a >= 100 &&
                a <= 107 &&
                t.push({
                  type: "setBackgroundColor",
                  value: { type: "named", name: q[a - 100 + 8] },
                });
    }
    return t;
  }
  ...
  function Q(e = J) {
    ...
    function n(e) {
      return (function () {
        ...
        for (let t = 0; t < 6; t++)
          for (let n = 0; n < 6; n++)
            for (let r = 0; r < 6; r++) a.push(s([e[t], e[n], e[r]]));
        let n = 8;
    ...
    const a = t.split(/\r?\n/),
      n = Q(
        Object.fromEntries(
          q.map((t) => [
            t,
            e.colors[`terminal.ansi${t[0].toUpperCase()}${t.substring(1)}`],
          ]),
        ),
      ),
      r = (function () {
            ...
            return o(
              ...
              a.map((e, n) => {
                ...
                return (
                  ...
                  e.fontStyle & s.Underline &&
                    r.push("text-decoration: underline"),
                  o(
                    "token",
                    { style: r.join("; "), tokens: a, token: e, index: n },
  ...
  class te extends F.Registry {
    ...
    resolveEmbeddedLanguages(e) {
      if (this._langGraph.has(e.id)) return;
      this._langGraph.set(e.id, e);

      if (!e.embeddedLangs) return;

      for (const t of e.embeddedLangs) {
        const embedded = this._langMap[t];
        if (embedded) this._langGraph.set(t, embedded);
      }
    }
  }
  function se(e) {
    return "string" == typeof e
      ? t.find((t) => t.id === e || t.aliases?.includes(e))
      : e;
  }
  ((e.BUNDLED_LANGUAGES = t),
    ...
    (e.getHighlighter = async function (e) {
      const {
            ...
            if (!x) {
              ...
              if (P)
                t =
                  "string" == typeof j
                    ? d.loadWASM({
                        data: await fetch(A(i(...o(e), "onig.wasm"))),
                      })
                    : d.loadWASM({ data: j });
              else {
        ...
        l = new te(c);
      (e.paths?.themes &&
        (l.themesPath = e.paths.themes.endsWith("/")
          ? e.paths.themes
          : e.paths.themes + "/"),
        e.paths?.languages &&
        ...
        return (function (e, t, s, n, r) {
          ...
          for (let s = 0, u = o.length; s < u; s++) {
            ...
            r.includeExplanation &&
              ((u = n.tokenizeLine(m, i)), (p = u.tokens), (h = 0));
            ...
            for (let s = 0; s < g; s++) {
              ...
              if (r.includeExplanation) {
                ...
                for (; n + t < o; ) {
                  ...
                  ((t += a.length),
                    f.push({ content: a, scopes: D(e, s.scopes) }),
                    h++);
                }
              }
              c.push({
                content: m.substring(n, o),
                color: l,
                fontStyle: u,
                explanation: f,
              });
